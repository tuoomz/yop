...
const YOP_ABI = [
  ...
  { inputs: [], name: "reserve", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "symbol", outputs: [{ internalType: "string", name: "", type: "string" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "team", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  {
    inputs: [],
    name: "tokenSale",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
  ...
  },
  {
    ...
    name: "unlock_MarketingDevRewards",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export default task("rewards:set-yop-allowance", "Set allowance of YOP tokens for the rewards contract")
  .addOptionalParam("yop", "YOP contract address", "0xAE1eaAE3F627AAca434127644371b67B18444051")
  ...
  .setAction(async (taskArguments, hre) => {
    ...
    const yop = await getContractAt(YOP_ABI, yopContractAddress);
    await yop.connect(wallet).approve(rewardAddress, allowance);
  });
