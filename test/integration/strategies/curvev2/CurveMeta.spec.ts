...
describe("CurveMetaStrategy [@skip-on-coverage]", async () => {
  ...
  beforeEach(async () => {
    ...
    curveStrategy = (await curveMetaFactory.deploy(
      ...
      CONST.USDN_META_POOL.ADDRESS,
      CONST.USDN_META_POOL.LP_TOKEN,
    ...
    curveMetaPool = (await ethers.getContractAt(CurveBasePoolABI, CONST.USDN_META_POOL.ADDRESS)) as ICurveDeposit;
  });
